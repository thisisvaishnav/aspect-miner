import { AspectResult, AnalysisResponse, Polarity } from "../types.js";
...
const POSITIVE_WORDS = [
  "good", "great", "excellent", "amazing", "fast", "love", "long",
  "beautiful", "smooth", "best", "fantastic", "wonderful", "superb",
  "brilliant", "outstanding", "impressive", "sharp", "crisp", "bright", "clear",
];

const NEGATIVE_WORDS = [
  "bad", "terrible", "awful", "slow", "hate", "short", "poor",
  "expensive", "ugly", "worst", "lag", "laggy", "dim", "blurry",
  "cheap", "broken", "frustrating", "disappointing", "mediocre", "overpriced",
];

const NEGATION_WORDS = [
  "not", "no", "never", "neither", "hardly", "barely", "doesn't", "don't", "isn't", "wasn't",
];
